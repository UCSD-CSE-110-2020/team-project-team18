...
public class ProposedWalk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button withdrawnWalk = (Button) findViewById(R.id.withdrawWalk);
        ...
        getProposedData(new FirestoreCallBack() {
            @Override
            public void onCallback(String propose_schedule, String proposer, String walk, String date, String time, List<String> list) {
        ...
        docRef.addSnapshotListener(new EventListener<DocumentSnapshot >() {
            ...
            public void onEvent(@Nullable DocumentSnapshot  document,
                ...
                if (document != null && document.exists()) {
                    ...
                    firestoreCallBack.onCallback(propose_schedule, walkProposer, walkName, walkDate, walkTime, list);
                } else {
    ...
    private interface FirestoreCallBack {
        void onCallback(String propose_schedule, String proposer, String name, String date, String time, List<String> list);
    }
