...
public class DailyStepCounterTest {
    ...
    private StepCounter activity;

    @Before
    public void setUp() {
        activity = Robolectric.buildActivity(StepCounter.class).create().resume().get();
    ...
    private class TestFitnessService implements FitnessService {
        ...
        private StepCounter stepActivity;

        public TestFitnessService(StepCounter stepActivity) {
